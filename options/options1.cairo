...
// TODO: Complete the function body - remember to return an Option!
    if time_of_day <= 23 {
        if time_of_day < 22 {
            ...
            Option::Some(0)  // Return 0 scoops for 22:00 and 23:00
        }
    } else {
        Option::None
    }
...
// below method works but will not pass through starkling
//   assert(icecreams == Option::Some(5), 'err_6'); // don't change this line
}
